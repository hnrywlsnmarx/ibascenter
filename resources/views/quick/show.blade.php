                        ...
                        <div class="table-wrapper">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <center><img width="400" id="imgc1_2" src="{{ asset('/public/storage/'.$data->path."/".$data->foto_c1_3) }}" alt="{{ asset('public/storage/'.$data->path."/".$data->foto_c1_3) }}"></center>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td><a type="submit" class="btn btn-sm btn-primary" href="{{ asset('/public/storage/'.$data->path."/".$data->foto_c1) }}" target="_blank">Check</a></td>
                                    <td><a type="submit" class="btn btn-sm btn-primary" href="{{ asset('/public/storage/'.$data->path."/".$data->foto_c1_1) }}" target="_blank">Check</a></td>
                                    <td><a type="submit" class="btn btn-sm btn-primary" href="{{ asset('/public/storage/'.$data->path."/".$data->foto_c1_2) }}" target="_blank">Check</a></td>
                                    <td><a type="submit" class="btn btn-sm btn-primary" href="{{ asset('/public/storage/'.$data->path."/".$data->foto_c1_3) }}" target="_blank">Check</a></td>
                                </tr>
                            </table>
                        </div>
                    </div>
